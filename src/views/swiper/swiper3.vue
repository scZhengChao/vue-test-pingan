            ...
            <div class="mySwiper-contain">
               <swiper class="swiperComp swiper-no-swiping" ref="swiperComp" :options='swiperOptions'>
                   <swiper-slide v-for='(item,index) in swiperData' :key="index">
                        <slide-comp :CustomerIntention='item.CustomerIntention' :ReplyDirection='item.ReplyDirection' :dialogue='item.dialogue' :RelatedObjection='item.RelatedObjection'></slide-comp>
                   </swiper-slide>
               </swiper>
            </div>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            addSlide(){
                ...
                this.swiperData.push(data)
                this.activeSwiperData = data
                this.toSlide(this.swiperData.length-1)  
                this.allSlides.push(data)
